...
start_meas=datetime(2015,2,20,19,25)
end_meas=datetime(2015,2,20,19,55)
data = FirrSeries(series,start_meas,end_meas,detector=4,illuminated_pixels=109)
...
data.get_radiance(filters,npos,method="next",spav="None",non_ill=1,save=True)
