...
filtres = ['F0011','F0007','F0036','F0035','F0010','F0014','F0008','F0009','F0034','open','open','blank','open','open','blank','open','open']
...
for k in list_filters:
    plot(time[::1],bt[::1,k]-273.15,"o-",markersize=2,mew=1.5,mfc="white",mec=colors[k],linewidth=1,label=labs[k],color=colors[k])
       
#xlabel(r"Black Body Radiance (W m$^{-2}$ sr$^{-1}$)",size=20)
ylabel(r"Brightness temperature ($^{\circ}$C)",size=22)
legend(loc=4,numpoints=1,ncol=3)  
...
fig.savefig("/home/quentin/Documents/Presentations/Figures/Others/brightness_temperature_%s.pdf"%date,dpi=300,format="pdf")  
